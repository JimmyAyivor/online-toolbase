...
export type SponsoredAd = {
  ...
  export const SPONSORED_ADS: Record<string, SponsoredAd> = {
    ...
    nordvpn: {
      ...
      destinationUrl: "https://go.nordvpn.net/aff_c?offer_id=15&aff_id=145493&url_id=902",
    ...
    nordpass: {
      ...
      creativeUrl: "/ads/nordvpn-creative.png",
      destinationUrl: "https://go.nordpass.io/aff_c?offer_id=488&aff_id=145493&url_id=9356",
      categories: ["Security", "Developer"],
      priority: 10,
      active: true,
    },
