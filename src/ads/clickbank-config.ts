...
export const CLICKBANK_PRODUCTS: Record<string, ClickBankProduct> = {
  ...
  geniusSong: {
    ...
    description:
      "A neuroscience-backed audio program that rewires memory and focus. Tens of thousands of users, 1.84% conversion rate.",
    badge: "1.84% CVR",
    icon: "🧠",
  ...
  brainSong: {
    ...
    description:
      "A proven audio-based memory training program. Gravity 183 — the highest-ranked product on the entire ClickBank marketplace.",
    badge: "Gravity 183",
    icon: "🎵",
    intentCluster: "brain_memory",
  ...
  memoryWave: {
    ...
    description:
      "A frequency-based audio program that activates long-term memory retention. 1.11% CVR, $54 average commission.",
    icon: "〰️",
    intentCluster: "brain_memory",
  ...
  geniusSwitch: {
    ...
    description:
      "A 7-minute daily audio ritual based on Stanford neuroplasticity research. 1.17% CVR — one of the highest in the brain niche.",
    badge: "1.17% CVR",
    icon: "💡",
    intentCluster: "brain_memory",
  ...
  energyRevolution: {
    ...
    description:
      "A natural energy system used by 85,000+ people. 1.21% CVR and $0.60 EPC — one of the most consistent converters on the marketplace.",
    badge: "1.21% CVR",
    icon: "⚡",
  ...
  yuSleep: {
    ...
    description:
      "The #1 sleep offer on ClickBank in 2026. $131 average commission per sale, Gravity 89. New VSL converts cold traffic.",
    badge: "$131 avg sale",
    icon: "😴",
    intentCluster: "sleep_energy",
    categories: ["Health"],
  ...
  derilaErgo: {
    ...
    description:
      "A memory foam pillow engineered for neck and shoulder alignment. 2.96% CVR — the highest on this list. Physical product, ships globally.",
  ...
  acvDetox: {
    ...
    description:
      "A proven weight loss programme using apple cider vinegar. 1.46% CVR, broad audience appeal — one of the safest bets for health tool pages.",
    badge: "1.46% CVR",
    icon: "🍎",
  ...
  moringaMagic: {
    ...
    description:
      "A moringa supplement with 46 antioxidants, studied for energy, immunity, and weight management. 1.02% CVR, $1.29 EPC, $130 avg commission.",
    badge: "$130 avg sale",
    icon: "🌿",
    intentCluster: "weight_health",
    categories: ["Health"],
  ...
  cardioSlimTea: {
    ...
    description:
      "A metabolism-boosting tea formula backed by 18 herbs. Gravity 67, $160 average commission — one of the highest-payout weight loss offers available.",
    badge: "$160 avg sale",
    icon: "🍵",
    intentCluster: "weight_health",
    categories: ["Health"],
  ...
  moneyScript: {
    ...
    description:
      "A neuroscience-based wealth psychology programme. 1.47% CVR and $0.75 EPC — one of the strongest performing finance offers in the marketplace.",
    badge: "1.47% CVR",
    icon: "💰",
  ...
  teslaWealthScript: {
    ...
    description:
      "A manifestation and wealth mindset programme based on Tesla's 369 method. 0.89% CVR, broad appeal across financial and business audiences.",
    icon: "⚡",
    intentCluster: "finance_income",
  ...
  soulManifest: {
    ...
    description:
      "A personalised manifestation programme based on your birth date and name. 1.20% CVR with a $34 average payout — broad appeal for social and fun audiences.",
    badge: "1.20% CVR",
    icon: "✨",
  ...
  tedsWoodworking: {
    ...
    description:
      "The highest-converting woodworking offer online. Gravity 108, 0.50% CVR. Evergreen DIY audience — appeals to the practical, hands-on users of calculator and converter tools.",
    badge: "Gravity 108",
    icon: "🪵",
  ...
  pianoforall: {
    ...
    description:
      "A revolutionary self-paced piano course used by 500,000+ students. 1.10% CVR and Gravity 42 — the most enduring education offer in the marketplace.",
    badge: "500k students",
    icon: "🎹",
  ...
  moonReading: {
    ...
    description:
      "An interactive astrology reading that generates a unique birth chart report. Gravity 83, 0.82% CVR — one of the most viral spiritual offers in the market.",
    badge: "Gravity 83",
    icon: "🌙",
