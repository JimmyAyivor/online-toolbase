...
const TOOL_URL = "https://www.onlinetoolbase.com/tools/profile-picture-resizer";
...
function ShareBar() {
  ...
  const shareText = encodeURIComponent(
    "Free profile picture resizer — resize profile photos for Instagram, LinkedIn, Twitter/X, TikTok, Discord, and more. Runs in your browser. No signup.",
  );
...
const PLATFORM_SIZES = [
  [
    "Instagram",
    "110×110px",
    "Displays at 110px on desktop; source renders at higher resolution on retina screens. Safe minimum is 320×320px source.",
  ],
  [
    "Facebook",
    "170×170px",
    "Profile photo displays at 170px on desktop, 128px on mobile. Uploads are cropped to square and stored at 720px.",
  ],
  [
    "Twitter / X",
    "400×400px",
    "Displays at 48px in the timeline but stored at 400px for sharp display on high-DPI screens. Use at least 400×400px source.",
  ],
  [
    "LinkedIn",
    "400×400px",
    "Profile photo minimum is 200×200px; 400×400px is recommended for sharp retina display on desktop and app.",
  ],
  [
    "YouTube",
    "800×800px",
    "Channel icon displays as a circle; minimum 98×98px but 800×800px recommended for all display contexts.",
  ],
  [
    "TikTok",
    "200×200px",
    "Profile photo minimum is 20×20px but 200×200px recommended. Displays as a circle in the feed and on profile.",
  ],
  [
    "Discord",
    "128×128px",
    "Avatar displays at 32–128px depending on context. 128px is the recommended upload size for sharpness everywhere.",
  ],
  [
    "WhatsApp",
    "192×192px",
    "Profile photo displays at small sizes in chat lists; 192×192px provides sufficient quality for all display sizes.",
  ],
  [
    "Slack",
    "512×512px",
    "Workspace profile photo; minimum 128×128px but 512×512px recommended for retina display and emoji-size icons.",
  ],
  [
    "GitHub",
    "460×460px",
    "Avatar used in repositories, pull requests, and comments. 460×460px is the standard stored size.",
  ],
];
    ...
    <>
      ...
      >
        <h2 className="text-4xl font-bold text-gray-900 mb-4 text-center">
          How to Use the Profile Picture Resizer
        </h2>
        <p className="text-lg text-gray-500 text-center max-w-2xl mx-auto mb-14 leading-relaxed">
          Upload your photo, select the platform, click Resize, and download the
          correctly sized PNG — your image never leaves your browser.
        </p>
          ...
          {[
            {
              ...
              enrich: (
                <div className="bg-pink-50 rounded-xl px-5 py-4 text-sm text-pink-800 leading-relaxed">
                  <strong>Source quality tip:</strong> If you're using a photo
                  taken on a smartphone, use the original full-resolution file
                  rather than a compressed or shared version — shared photos are
                  often resized and compressed before sharing. For logos, use
                  the highest-resolution PNG from your design files. Starting
                  with a high-quality source is the single most important factor
                  in getting a sharp profile picture at any platform size.
                </div>
              ),
            },
            {
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {PLATFORM_SIZES.map(([platform, size, note]) => (
                        <tr key={platform} className="hover:bg-pink-50">
                          <td className="px-3 py-2 font-bold text-pink-700 text-xs whitespace-nowrap">
                            {platform}
                          </td>
            ...
            },
            {
              ...
              enrich: (
                <div className="bg-rose-50 rounded-xl px-5 py-4 text-sm text-rose-800 leading-relaxed">
                  <strong>Centre-crop note:</strong> The tool automatically
                  crops from the centre of your image. If your subject is
                  off-centre (for example, you're standing to one side of a
                  landscape photo), pre-crop your image in a photo editor first
                  — position the subject centrally in a square crop — then
                  upload the pre-cropped image for the best result.
                </div>
              ),
            },
            {
              ...
              enrich: (
                <div className="bg-pink-50 rounded-xl px-5 py-4 text-sm text-pink-800 leading-relaxed">
                  <strong>Batch workflow:</strong> Upload once, then click
                  through each platform in turn — Instagram, Facebook, LinkedIn,
                  Twitter/X — clicking Resize and Download for each. All files
                  are saved to your device's default download folder with
                  platform-specific names. You can then upload the correct file
                  for each platform without confusion.
                </div>
              ),
            },
          ...
          {[
            {
              ...
              desc: "Update your profile picture across all platforms at once — resize one source photo to all 10 platform sizes in a single session.",
            },
            {
              emoji: "🏢",
              title: "Brand and business profiles",
              desc: "Resize your logo or brand graphic for consistent visual identity across Instagram, LinkedIn, Twitter/X, YouTube, and Discord.",
            },
            {
              emoji: "🎙️",
              title: "Podcast and creator profiles",
              desc: "Resize a headshot or show artwork for use across YouTube, Spotify, podcast directories, and social media profiles.",
            },
            {
              emoji: "💼",
              title: "Professional LinkedIn update",
              desc: "Resize a professional headshot specifically to LinkedIn's recommended 400×400px dimensions for sharp display on desktop and mobile.",
            },
            {
              emoji: "🎮",
              title: "Discord and gaming community",
              desc: "Resize an avatar or character art to Discord's 128×128 recommended size for sharp display across all server contexts.",
            },
            {
              emoji: "🔄",
              title: "Consistent multi-platform presence",
              desc: "Use the same source photo for all platforms — ensuring your profile is recognisable across every network where you have a presence.",
            },
        ...
        <div className="bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl p-8 text-white text-center mb-14">
          ...
          <h3 className="text-xl font-bold mb-3">
            Your profile picture is the first thing every visitor sees — the
            right size makes it sharp on every screen
          </h3>
          <p className="text-pink-100 leading-relaxed max-w-xl mx-auto text-sm">
            A blurry or poorly cropped profile photo is one of the most
            noticeable signs of an unpolished social media presence — and one of
            the easiest to fix. Each platform has specific size requirements
            that ensure your photo displays sharply on both standard and
            high-DPI (Retina) screens. Uploading the wrong size means the
            platform scales your image up or applies its own cropping, which
            often cuts off your face or logo in unexpected places. This tool
            resizes and centre-crops to the exact dimensions each platform
            expects — process your source once, download for all platforms, and
            upload the correct file everywhere.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Crop and resize images with custom dimensions — set exact pixel width and height for any use.",
              },
              {
                href: "/tools/image-compressor",
                label: "Image Compressor",
                desc: "Reduce image file size without visible quality loss — useful before uploading to social platforms.",
              },
              {
                href: "/tools/favicon-generator",
                label: "Favicon Generator",
                desc: "Generate favicons in all standard sizes from any image — download PNGs, ICO, and webmanifest.",
              },
            ].map(({ href, label, desc }) => (
              <a
                key={href}
