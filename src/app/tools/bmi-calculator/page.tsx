...
export const metadata: Metadata = {
  ...
  description: "Calculate your Body Mass Index and discover your healthy weight range. Free, instant, no signup required.",
  keywords: "bmi calculator, free bmi calculator, online bmi calculator, bmi calculator free, bmi calculator online, health tool, free online bmi calculator, best bmi calculator",
  ...
  openGraph: {
    ...
    description: "Calculate your Body Mass Index and discover your healthy weight range. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/bmi-calculator.png`, width: 1200, height: 630, alt: "Free Online BMI Calculator" }],
  },
  twitter: {
    ...
    title:       "BMI Calculator — Free Online BMI Calculator",
    description: "Calculate your Body Mass Index and discover your healthy weight range.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "BMI Calculator",           item: `${SITE_URL}/tools/bmi-calculator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">BMI Calculator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Calculate your Body Mass Index and discover your healthy weight range. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-bmi-calculator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-bmi-calculator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free BMI Calculator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>bmi calculator</strong> is designed for speed and
              simplicity. Calculate your Body Mass Index and discover your healthy weight range. No software installation or account is required —
