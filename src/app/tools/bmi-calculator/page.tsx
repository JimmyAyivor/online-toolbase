  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-bmi-calculator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-bmi-calculator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free BMI Calculator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>bmi calculator</strong> is designed for
              speed and simplicity. Calculate your Body Mass Index and discover
              your healthy weight range. No software installation or account is
