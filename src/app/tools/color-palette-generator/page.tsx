...
export const metadata: Metadata = {
  title: "Color Palette Generator — Free Online Color Palette Generator | Free Online Tools",
  description: "Generate harmonious color palettes for your design projects. Free, instant, no signup required.",
  keywords: "color palette generator, free color palette generator, online color palette generator, color palette generator free, color palette generator online, image tool, free online color palette generator, best color palette generator",
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/og/color-palette-generator.png`, width: 1200, height: 630, alt: "Free Online Color Palette Generator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Color Palette Generator",           item: `${SITE_URL}/tools/color-palette-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Color Palette Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Color Palette Generator — Free Online Color Palette Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate harmonious color palettes for your design projects. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-color-palette-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-color-palette-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Color Palette Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>color palette generator</strong> is designed for speed and
              simplicity. Generate harmonious color palettes for your design projects. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
            { href: "/tools/hex-color-code-generator", label: "Hex Color Code Generator", desc: "Generate hex color codes with a color picker, HEX, RGB, and HSL values." },
