...
export const metadata: Metadata = {
  title: "Text Summarizer — Free Online Text Summarizer",
  description:
    "Summarize long text into concise key points instantly. Adjustable summary length — runs entirely in your browser.",
  keywords:
    "text summarizer, free text summarizer, online text summarizer, summarize text, writing tool, free summarizer",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <h1 className='sr-only'>
          Text Summarizer — Free Online Text Summarizer
        </h1>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-text-summarizer'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-text-summarizer'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Text Summarizer
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>text summarizer</strong> is designed for
              speed and simplicity. Summarize long text into concise key points
              instantly. No software installation or account is required — just
          ...
          <div className='mt-8'>
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4'>
              {[
                ...
                {
                  href: "/tools/text-to-bullet-points",
                  label: "Text to Bullet Points",
                  desc: "Convert any paragraph into clean bullet point lists.",
                },
              ].map((link) => (
                <a
                  key={link.href}
