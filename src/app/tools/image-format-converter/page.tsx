...
export const metadata: Metadata = {
  ...
  keywords:
    "image format converter, free image format converter, online image format converter, image format converter free, image format converter online, image tool, free online image format converter, best image format converter",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Convert images between PNG, JPG, WebP, and other formats online. Free,
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-image-format-converter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-image-format-converter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Image Format Converter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>image format converter</strong> is
              designed for speed and simplicity. Convert images between PNG,
              JPG, WebP, and other formats online. No software installation or
