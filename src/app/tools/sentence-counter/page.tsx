...
export const metadata: Metadata = {
  title: "Sentence Counter — Free Online Sentence Counter",
  description:
    "Count sentences, paragraphs and reading level of your text. Live stats including Flesch-Kincaid grade level.",
  keywords:
    "sentence counter, count sentences, paragraph counter, reading level, flesch kincaid, writing tool, free sentence counter",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <h1 className='sr-only'>
          Sentence Counter — Free Online Sentence Counter
        </h1>
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Count sentences, paragraphs and reading level of your text.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-sentence-counter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-sentence-counter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Sentence Counter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>sentence counter</strong> is designed for
              speed and simplicity. Count sentences, paragraphs and reading
              level of your text. No software installation or account is
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4'>
              {[
                ...
                },
                {
                  ...
                  desc: "Estimate reading time for any piece of text.",
                },
                {
