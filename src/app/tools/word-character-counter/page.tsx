...
export const metadata: Metadata = {
  ...
  keywords:
    "word & character counter, free word & character counter, online word & character counter, word & character counter free, word & character counter online, writing tool, free online word & character counter, best word & character counter",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          ...
          estimates. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-word-character-counter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-word-character-counter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Word & Character Counter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>word & character counter</strong> is
              designed for speed and simplicity. Count words, characters,
              sentences, and paragraphs with reading time estimates. No software
