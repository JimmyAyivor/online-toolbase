...
export const metadata: Metadata = {
  title: "URL Encoder/Decoder — Free Online URL Encoder/Decoder | Free Online Tools",
  description: "Encode or decode URLs for safe web transmission. Free, instant, no signup required.",
  keywords: "url encoder/decoder, free url encoder/decoder, online url encoder/decoder, url encoder/decoder free, url encoder/decoder online, developer tool, free online url encoder/decoder, best url encoder/decoder",
  ...
  openGraph: {
    ...
    description: "Encode or decode URLs for safe web transmission. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/url-encoder-decoder.png`, width: 1200, height: 630, alt: "Free Online URL Encoder/Decoder" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "URL Encoder/Decoder",           item: `${SITE_URL}/tools/url-encoder-decoder` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">URL Encoder/Decoder</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">URL Encoder/Decoder — Free Online URL Encoder/Decoder</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Encode or decode URLs for safe web transmission. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-url-encoder-decoder" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-url-encoder-decoder" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free URL Encoder/Decoder
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>url encoder/decoder</strong> is designed for speed and
              simplicity. Encode or decode URLs for safe web transmission. No software installation or account is required —
