...
export const metadata: Metadata = {
  title: "Text Case Converter — Free Online Text Case Converter | Free Online Tools",
  description: "Convert text to uppercase, lowercase, title case, camelCase, and snake_case. Free, instant, no signup required.",
  keywords: "text case converter, free text case converter, online text case converter, text case converter free, text case converter online, writing tool, free online text case converter, best text case converter",
  ...
  openGraph: {
    ...
    description: "Convert text to uppercase, lowercase, title case, camelCase, and snake_case. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/text-case-converter.png`, width: 1200, height: 630, alt: "Free Online Text Case Converter" }],
  },
  twitter: {
    ...
    title:       "Text Case Converter — Free Online Text Case Converter",
    description: "Convert text to uppercase, lowercase, title case, camelCase, and snake_case.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Text Case Converter",           item: `${SITE_URL}/tools/text-case-converter` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Text Case Converter</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Text Case Converter — Free Online Text Case Converter</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Convert text to uppercase, lowercase, title case, camelCase, and snake_case. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-text-case-converter" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-text-case-converter" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Text Case Converter
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>text case converter</strong> is designed for speed and
              simplicity. Convert text to uppercase, lowercase, title case, camelCase, and snake_case. No software installation or account is required —
