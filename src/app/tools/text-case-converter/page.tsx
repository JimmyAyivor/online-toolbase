...
export const metadata: Metadata = {
  ...
  keywords:
    "text case converter, free text case converter, online text case converter, text case converter free, text case converter online, writing tool, free online text case converter, best text case converter",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          ...
          snake_case. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-text-case-converter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-text-case-converter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Text Case Converter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>text case converter</strong> is designed
              for speed and simplicity. Convert text to uppercase, lowercase,
              title case, camelCase, and snake_case. No software installation or
