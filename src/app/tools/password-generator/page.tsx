...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: SITE_URL },
    {
      ...
      position: 2,
      name: "Security Tools",
      item: `${SITE_URL}/?category=security`,
    },
    {
      "@type": "ListItem",
      position: 3,
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-password-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-password-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Password Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>password generator</strong> is designed
              for speed and simplicity. Generate strong, secure, random
              passwords with customizable options. No software installation or
