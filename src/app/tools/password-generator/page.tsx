...
export const metadata: Metadata = {
  title: "Password Generator — Free Online Password Generator | Free Online Tools",
  description: "Generate strong, secure, random passwords with customizable options. Free, instant, no signup required.",
  keywords: "password generator, free password generator, online password generator, password generator free, password generator online, security tool, free online password generator, best password generator",
  ...
  openGraph: {
    ...
    description: "Generate strong, secure, random passwords with customizable options. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/password-generator.png`, width: 1200, height: 630, alt: "Free Online Password Generator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Security Tools", item: `${SITE_URL}/?category=security` },
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li><a href="/?category=security" className="hover:text-indigo-600 transition-colors">Security Tools</a></li>
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Password Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Password Generator — Free Online Password Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate strong, secure, random passwords with customizable options. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-password-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-password-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Password Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>password generator</strong> is designed for speed and
              simplicity. Generate strong, secure, random passwords with customizable options. No software installation or account is required —
