...
export const metadata: Metadata = {
  ...
  description: "Calculate your semester and cumulative GPA with multiple grading scale support. Free, instant, no signup required.",
  keywords: "gpa calculator, free gpa calculator, online gpa calculator, gpa calculator free, gpa calculator online, education tool, free online gpa calculator, best gpa calculator",
  ...
  openGraph: {
    ...
    description: "Calculate your semester and cumulative GPA with multiple grading scale support. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/gpa-calculator.png`, width: 1200, height: 630, alt: "Free Online GPA Calculator" }],
  },
  twitter: {
    ...
    title:       "GPA Calculator — Free Online GPA Calculator",
    description: "Calculate your semester and cumulative GPA with multiple grading scale support.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Education Tools", item: `${SITE_URL}/?category=education` },
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li><a href="/?category=education" className="hover:text-indigo-600 transition-colors">Education Tools</a></li>
          <li aria-hidden="true" className="text-gray-300">/</li>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        <p className="text-xs font-semibold text-indigo-600 uppercase tracking-widest mb-1">
          Free Education Tool · No Signup · Works Instantly
        </p>
        <h1 className="sr-only">GPA Calculator — Free Online GPA Calculator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Calculate your semester and cumulative GPA with multiple grading scale support. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-gpa-calculator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-gpa-calculator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free GPA Calculator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>gpa calculator</strong> is designed for speed and
              simplicity. Calculate your semester and cumulative GPA with multiple grading scale support. No software installation or account is required —
