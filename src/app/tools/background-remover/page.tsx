  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-background-remover'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-background-remover'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Background Remover
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>background remover</strong> is designed
              for speed and simplicity. Remove image backgrounds automatically
              with AI-powered precision. No software installation or account is
