...
export const metadata: Metadata = {
  title: "Instagram Post Planner — Free Online Instagram Post Planner | Free Online Tools",
  description: "Plan and organize Instagram posts with captions and scheduling ideas. Free, instant, no signup required.",
  keywords: "instagram post planner, free instagram post planner, online instagram post planner, instagram post planner free, instagram post planner online, social media tool, free online instagram post planner, best instagram post planner",
  ...
  openGraph: {
    ...
    description: "Plan and organize Instagram posts with captions and scheduling ideas. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/instagram-post-planner.png`, width: 1200, height: 630, alt: "Free Online Instagram Post Planner" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Instagram Post Planner",           item: `${SITE_URL}/tools/instagram-post-planner` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Instagram Post Planner</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Instagram Post Planner — Free Online Instagram Post Planner</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Plan and organize Instagram posts with captions and scheduling ideas. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-instagram-post-planner" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-instagram-post-planner" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Instagram Post Planner
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>instagram post planner</strong> is designed for speed and
              simplicity. Plan and organize Instagram posts with captions and scheduling ideas. No software installation or account is required —
