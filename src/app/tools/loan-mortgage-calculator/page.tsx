...
export const metadata: Metadata = {
  ...
  keywords:
    "loan & mortgage calculator, free loan & mortgage calculator, online loan & mortgage calculator, loan & mortgage calculator free, loan & mortgage calculator online, calculator tool, free online loan & mortgage calculator, best loan & mortgage calculator",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          ...
          schedules. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-loan-mortgage-calculator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-loan-mortgage-calculator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Loan & Mortgage Calculator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>loan & mortgage calculator</strong> is
              designed for speed and simplicity. Calculate monthly loan
              payments, total interest, and amortization schedules. No software
              ...
              {[
                {
                  ...
                  desc: "Calculate compound interest and see your investment grow over time.",
                },
                {
