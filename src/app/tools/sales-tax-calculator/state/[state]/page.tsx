...
<h2 className="text-2xl font-semibold">
  Sales Tax in {state.name}
</h2>

<p>
  The statewide base sales tax rate in {state.name} is {state.rate}%. 
  Local cities and counties may add additional taxes, increasing the final rate.
</p>
...
<p>
  If you buy an item for $100 in {state.name}, the estimated tax would be:
</p>
...
<p>
  To remove tax from a total price in {state.name}, divide the total by 
  (1 + tax rate).
</p>
