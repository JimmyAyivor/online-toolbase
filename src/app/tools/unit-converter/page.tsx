...
export const metadata: Metadata = {
  ...
  keywords:
    "unit converter, free unit converter, online unit converter, unit converter free, unit converter online, calculator tool, free online unit converter, best unit converter",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Convert between length, weight, temperature, volume, speed, and time
          units. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-unit-converter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-unit-converter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Unit Converter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>unit converter</strong> is designed for
              speed and simplicity. Convert between length, weight, temperature,
              volume, speed, and time units. No software installation or account
              ...
              {[
                {
                  ...
                  desc: "Convert between 30+ world currencies with live exchange rates.",
                },
                {
