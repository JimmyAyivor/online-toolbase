...
export const metadata: Metadata = {
  title: "Text to Bullet Points — Free Online Text to Bullet Points",
  description:
    "Convert any paragraph into clean bullet point lists instantly. Choose bullet, dash or numbered style.",
  keywords:
    "text to bullet points, convert text to bullets, paragraph to bullet points, free bullet point converter, writing tool",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Free Online Text to Bullet Points",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <h1 className='sr-only'>
          Text to Bullet Points — Free Online Text to Bullet Points
        </h1>
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Convert any paragraph into clean bullet point lists.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-text-to-bullet-points'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-text-to-bullet-points'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Text to Bullet Points
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>text to bullet points</strong> is designed
              for speed and simplicity. Convert any paragraph into clean bullet
              point lists. No software installation or account is required —
              ...
              {[
                {
                  ...
                  desc: "Summarize long text into concise key points.",
                },
                {
                ...
                },
                {
                  ...
                  desc: "Rewrite text with different words while keeping meaning.",
                },
              ].map((link) => (
                <a
                  key={link.href}
