...
export const metadata: Metadata = {
  title: "Plagiarism Checker — Free Online Plagiarism Checker | Free Online Tools",
  description: "Detect duplicate content and plagiarism in your text. Free, instant, no signup required.",
  keywords: "plagiarism checker, free plagiarism checker, online plagiarism checker, plagiarism checker free, plagiarism checker online, writing tool, free online plagiarism checker, best plagiarism checker",
  ...
  openGraph: {
    ...
    description: "Detect duplicate content and plagiarism in your text. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/plagiarism-checker.png`, width: 1200, height: 630, alt: "Free Online Plagiarism Checker" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Plagiarism Checker",           item: `${SITE_URL}/tools/plagiarism-checker` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Plagiarism Checker</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Plagiarism Checker — Free Online Plagiarism Checker</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Detect duplicate content and plagiarism in your text. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-plagiarism-checker" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-plagiarism-checker" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Plagiarism Checker
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>plagiarism checker</strong> is designed for speed and
              simplicity. Detect duplicate content and plagiarism in your text. No software installation or account is required —
