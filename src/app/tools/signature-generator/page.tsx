...
export const metadata: Metadata = {
  ...
  keywords:
    "signature generator, free signature generator, online signature generator, signature generator free, signature generator online, business tool, free online signature generator, best signature generator",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Create a custom digital signature with stylish fonts for documents and
          emails. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-signature-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-signature-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Signature Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>signature generator</strong> is designed
              for speed and simplicity. Create a custom digital signature with
              stylish fonts for documents and emails. No software installation
