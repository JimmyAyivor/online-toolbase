...
export const metadata: Metadata = {
  ...
  description: "Test and debug regular expressions against sample text in real time. Free, instant, no signup required.",
  keywords: "regex tester, free regex tester, online regex tester, regex tester free, regex tester online, developer tool, free online regex tester, best regex tester",
  ...
  openGraph: {
    ...
    description: "Test and debug regular expressions against sample text in real time. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/regex-tester.png`, width: 1200, height: 630, alt: "Free Online Regex Tester" }],
  },
  twitter: {
    ...
    title:       "Regex Tester — Free Online Regex Tester",
    description: "Test and debug regular expressions against sample text in real time.",
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Regex Tester</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Regex Tester — Free Online Regex Tester</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Test and debug regular expressions against sample text in real time. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-regex-tester" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-regex-tester" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Regex Tester
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>regex tester</strong> is designed for speed and
              simplicity. Test and debug regular expressions against sample text in real time. No software installation or account is required —
