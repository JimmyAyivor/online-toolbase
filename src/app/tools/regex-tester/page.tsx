...
export const metadata: Metadata = {
  ...
  keywords:
    "regex tester, free regex tester, online regex tester, regex tester free, regex tester online, developer tool, free online regex tester, best regex tester",
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-regex-tester'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-regex-tester'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Regex Tester
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>regex tester</strong> is designed for
              speed and simplicity. Test and debug regular expressions against
              sample text in real time. No software installation or account is
