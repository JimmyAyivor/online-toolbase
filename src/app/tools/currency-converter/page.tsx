...
export const metadata: Metadata = {
  title: "Currency Converter — Free Online Currency Converter | Free Online Tools",
  description: "Convert between 30+ world currencies with live exchange rates. Free, instant, no signup required.",
  keywords: "currency converter, free currency converter, online currency converter, currency converter free, currency converter online, finance tool, free online currency converter, best currency converter",
  ...
  openGraph: {
    ...
    description: "Convert between 30+ world currencies with live exchange rates. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/currency-converter.png`, width: 1200, height: 630, alt: "Free Online Currency Converter" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Finance Tools", item: `${SITE_URL}/?category=finance` },
    { "@type": "ListItem", position: 3, name: "Currency Converter",           item: `${SITE_URL}/tools/currency-converter` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li><a href="/?category=finance" className="hover:text-indigo-600 transition-colors">Finance Tools</a></li>
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Currency Converter</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Currency Converter — Free Online Currency Converter</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Convert between 30+ world currencies with live exchange rates. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-currency-converter" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-currency-converter" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Currency Converter
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>currency converter</strong> is designed for speed and
              simplicity. Convert between 30+ world currencies with live exchange rates. No software installation or account is required —
