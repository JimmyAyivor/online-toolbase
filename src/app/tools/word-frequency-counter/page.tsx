...
export const metadata: Metadata = {
  title: "Word Frequency Counter — Free Online Word Frequency Counter | Free Online Tools",
  description: "Count the frequency of every word in your text. Free, instant, no signup required.",
  keywords: "word frequency counter, free word frequency counter, online word frequency counter, word frequency counter free, word frequency counter online, writing tool, free online word frequency counter, best word frequency counter",
  ...
  openGraph: {
    ...
    description: "Count the frequency of every word in your text. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/word-frequency-counter.png`, width: 1200, height: 630, alt: "Free Online Word Frequency Counter" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Word Frequency Counter",           item: `${SITE_URL}/tools/word-frequency-counter` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Word Frequency Counter</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Word Frequency Counter — Free Online Word Frequency Counter</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Count the frequency of every word in your text. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-word-frequency-counter" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-word-frequency-counter" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Word Frequency Counter
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>word frequency counter</strong> is designed for speed and
              simplicity. Count the frequency of every word in your text. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            { href: "/tools/text-difference-checker", label: "Text Difference Checker", desc: "Compare two pieces of text and highlight the differences instantly." },
              ].map((link) => (
                <a
                  key={link.href}
                  href={link.href}
