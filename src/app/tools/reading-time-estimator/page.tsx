...
export const metadata: Metadata = {
  title: "Reading Time Estimator — Free Online Reading Time Estimator | Free Online Tools",
  description: "Estimate how long it will take to read any piece of text. Free, instant, no signup required.",
  keywords: "reading time estimator, free reading time estimator, online reading time estimator, reading time estimator free, reading time estimator online, writing tool, free online reading time estimator, best reading time estimator",
  ...
  openGraph: {
    ...
    description: "Estimate how long it will take to read any piece of text. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/reading-time-estimator.png`, width: 1200, height: 630, alt: "Free Online Reading Time Estimator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Reading Time Estimator",           item: `${SITE_URL}/tools/reading-time-estimator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Reading Time Estimator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Reading Time Estimator — Free Online Reading Time Estimator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Estimate how long it will take to read any piece of text. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-reading-time-estimator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-reading-time-estimator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Reading Time Estimator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>reading time estimator</strong> is designed for speed and
              simplicity. Estimate how long it will take to read any piece of text. No software installation or account is required —
