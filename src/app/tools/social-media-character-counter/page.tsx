...
export const metadata: Metadata = {
  ...
  keywords:
    "social media character counter, free social media character counter, online social media character counter, social media character counter free, social media character counter online, utilities tool, free online social media character counter, best social media character counter",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <h1 className='sr-only'>
          Social Media Character Counter — Free Online Social Media Character
          Counter
        </h1>
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Count characters and optimize posts for platform limits. Free,
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-social-media-character-counter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-social-media-character-counter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Social Media Character Counter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>social media character counter</strong> is
              designed for speed and simplicity. Count characters and optimize
              posts for platform limits. No software installation or account is
              ...
              {[
                {
                  ...
                  desc: "Create structured and engaging Twitter threads for better storytelling.",
                },
                {
