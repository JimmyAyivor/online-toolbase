...
export const metadata: Metadata = {
  ...
  keywords:
    "text difference checker, free text difference checker, online text difference checker, text difference checker free, text difference checker online, writing tool, free online text difference checker, best text difference checker",
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-text-difference-checker'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-text-difference-checker'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Text Difference Checker
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>text difference checker</strong> is
              designed for speed and simplicity. Compare two pieces of text and
              highlight the differences instantly. No software installation or
