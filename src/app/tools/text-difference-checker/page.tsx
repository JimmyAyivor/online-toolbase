...
export const metadata: Metadata = {
  title: "Text Difference Checker — Free Online Text Difference Checker | Free Online Tools",
  description: "Compare two pieces of text and highlight the differences instantly. Free, instant, no signup required.",
  keywords: "text difference checker, free text difference checker, online text difference checker, text difference checker free, text difference checker online, writing tool, free online text difference checker, best text difference checker",
  ...
  openGraph: {
    ...
    description: "Compare two pieces of text and highlight the differences instantly. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/text-difference-checker.png`, width: 1200, height: 630, alt: "Free Online Text Difference Checker" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Text Difference Checker",           item: `${SITE_URL}/tools/text-difference-checker` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Text Difference Checker</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Text Difference Checker — Free Online Text Difference Checker</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Compare two pieces of text and highlight the differences instantly. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-text-difference-checker" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-text-difference-checker" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Text Difference Checker
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>text difference checker</strong> is designed for speed and
              simplicity. Compare two pieces of text and highlight the differences instantly. No software installation or account is required —
