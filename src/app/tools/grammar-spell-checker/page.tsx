...
export const metadata: Metadata = {
  ...
  keywords:
    "grammar & spell checker, free grammar & spell checker, online grammar & spell checker, grammar & spell checker free, grammar & spell checker online, writing tool, free online grammar & spell checker, best grammar & spell checker",
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-grammar-spell-checker'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-grammar-spell-checker'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Grammar & Spell Checker
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>grammar & spell checker</strong> is
              designed for speed and simplicity. Automatically correct grammar
              and spelling errors in your writing. No software installation or
