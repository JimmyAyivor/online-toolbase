...
export const metadata: Metadata = {
  title: "Time Zone Converter — Free Online Time Zone Converter | Free Online Tools",
  description: "Convert time between any two time zones worldwide with daylight saving support. Free, instant, no signup required.",
  keywords: "time zone converter, free time zone converter, online time zone converter, time zone converter free, time zone converter online, productivity tool, free online time zone converter, best time zone converter",
  ...
  openGraph: {
    ...
    description: "Convert time between any two time zones worldwide with daylight saving support. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/time-zone-converter.png`, width: 1200, height: 630, alt: "Free Online Time Zone Converter" }],
  },
  twitter: {
    ...
    title:       "Time Zone Converter — Free Online Time Zone Converter",
    description: "Convert time between any two time zones worldwide with daylight saving support.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Time Zone Converter",           item: `${SITE_URL}/tools/time-zone-converter` },
  ],
};
  ...
  return (
    <>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Time Zone Converter — Free Online Time Zone Converter</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Convert time between any two time zones worldwide with daylight saving support. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-time-zone-converter" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-time-zone-converter" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Time Zone Converter
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>time zone converter</strong> is designed for speed and
              simplicity. Convert time between any two time zones worldwide with daylight saving support. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
            { href: "/tools/pomodoro-timer", label: "Pomodoro Timer", desc: "Boost your focus and productivity with the Pomodoro time management technique." },
