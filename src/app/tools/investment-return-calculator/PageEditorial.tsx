"use client";
// src/app/tools/investment-return-calculator/PageEditorial.tsx
...
const TOOL_URL ="https://www.utilvia.com/tools/investment-return-calculator";
const TOOL_NAME = "Investment Return Calculator";
...
function ShareBar() {
  ...
  const st = encodeURIComponent(
    "Free investment return calculator — see how compound interest grows your investment over time",
  );
    ...
    <>
      ...
      >
        ...
        <p className="text-lg text-gray-500 text-center max-w-2xl mx-auto mb-14 leading-relaxed">
          Enter your initial investment, monthly contributions, annual return
          rate, and time horizon to see your projected balance and a
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                Enter your investment return details
              </h3>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-14">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Model your retirement account growth over 20–35 years with
              realistic return rates to see whether your contribution level puts
              you on track.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Calculate whether investing a lump sum over 5 years beats keeping
              it in a savings account for a down payment target.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">👶</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Project an education fund started at birth with monthly
              contributions to see the total available at age 18.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">📊</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Compare two scenarios: investing a windfall now vs spreading it as
              monthly contributions, to see which strategy grows more.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">🌍</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Compare growth of identical portfolios in different currencies by
              entering the same parameters — growth % is currency-agnostic.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">🔄</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Use the 4% rule: your FIRE number = desired annual income ÷ 0.04.
              Then use this calculator to find when your portfolio reaches that
              target.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white text-center mb-14">
          ...
          <p className="text-blue-100 leading-relaxed max-w-xl mx-auto text-sm">
            Results assume a fixed annual return rate — real investment returns
            fluctuate and are not guaranteed. Past performance does not predict
            future results. This tool does not constitute investment advice.
            Consult a registered financial advisor before making investment
            decisions.
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Project retirement savings and sustainable withdrawal amounts.
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Calculate how long to reach any savings target.
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Find budget room to increase monthly investment contributions.
              </div>
            </a>
          </div>
        </div>
