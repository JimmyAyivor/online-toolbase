...
export const metadata: Metadata = {
  ...
  keywords:
    "pdf merger & splitter, free pdf merger & splitter, online pdf merger & splitter, pdf merger & splitter free, pdf merger & splitter online, document tool, free online pdf merger & splitter, best pdf merger & splitter",
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-pdf-merger-splitter'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-pdf-merger-splitter'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free PDF Merger & Splitter
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>pdf merger & splitter</strong> is designed
              for speed and simplicity. Merge multiple PDF files into one or
              split a PDF into separate pages. No software installation or
