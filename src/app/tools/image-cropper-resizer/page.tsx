...
export const metadata: Metadata = {
  title: "Image Cropper & Resizer — Free Online Image Cropper & Resizer | Free Online Tools",
  description: "Crop and resize images quickly online without any software. Free, instant, no signup required.",
  keywords: "image cropper & resizer, free image cropper & resizer, online image cropper & resizer, image cropper & resizer free, image cropper & resizer online, image tool, free online image cropper & resizer, best image cropper & resizer",
  ...
  openGraph: {
    ...
    description: "Crop and resize images quickly online without any software. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/image-cropper-resizer.png`, width: 1200, height: 630, alt: "Free Online Image Cropper & Resizer" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Image Cropper & Resizer",           item: `${SITE_URL}/tools/image-cropper-resizer` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Image Cropper & Resizer</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Image Cropper & Resizer — Free Online Image Cropper & Resizer</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Crop and resize images quickly online without any software. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-image-cropper-resizer" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-image-cropper-resizer" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Image Cropper & Resizer
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>image cropper & resizer</strong> is designed for speed and
              simplicity. Crop and resize images quickly online without any software. No software installation or account is required —
