...
export const metadata: Metadata = {
  ...
  description: "Generate MD5, SHA1, SHA256, and other cryptographic hashes online. Free, instant, no signup required.",
  keywords: "hash generator, free hash generator, online hash generator, hash generator free, hash generator online, developer tool, free online hash generator, best hash generator",
  ...
  openGraph: {
    ...
    description: "Generate MD5, SHA1, SHA256, and other cryptographic hashes online. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/hash-generator.png`, width: 1200, height: 630, alt: "Free Online Hash Generator" }],
  },
  twitter: {
    ...
    title:       "Hash Generator — Free Online Hash Generator",
    description: "Generate MD5, SHA1, SHA256, and other cryptographic hashes online.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Hash Generator",           item: `${SITE_URL}/tools/hash-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Hash Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Hash Generator — Free Online Hash Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate MD5, SHA1, SHA256, and other cryptographic hashes online. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-hash-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-hash-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Hash Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>hash generator</strong> is designed for speed and
              simplicity. Generate MD5, SHA1, SHA256, and other cryptographic hashes online. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
            { href: "/tools/password-generator", label: "Password Generator", desc: "Generate strong, secure, random passwords with customizable options." },
