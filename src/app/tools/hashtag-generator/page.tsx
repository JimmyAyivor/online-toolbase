...
export const metadata: Metadata = {
  title: "Hashtag Generator — Free Online Hashtag Generator | Free Online Tools",
  description: "Generate relevant hashtags to increase reach and discoverability. Free, instant, no signup required.",
  keywords: "hashtag generator, free hashtag generator, online hashtag generator, hashtag generator free, hashtag generator online, social media tool, free online hashtag generator, best hashtag generator",
  ...
  openGraph: {
    ...
    description: "Generate relevant hashtags to increase reach and discoverability. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/hashtag-generator.png`, width: 1200, height: 630, alt: "Free Online Hashtag Generator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Hashtag Generator",           item: `${SITE_URL}/tools/hashtag-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Hashtag Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Hashtag Generator — Free Online Hashtag Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate relevant hashtags to increase reach and discoverability. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-hashtag-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-hashtag-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Hashtag Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>hashtag generator</strong> is designed for speed and
              simplicity. Generate relevant hashtags to increase reach and discoverability. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            { href: "/tools/tiktok-hook-generator", label: "TikTok Hook Generator", desc: "Generate engaging TikTok hooks that capture attention instantly." },
            { href: "/tools/social-media-bio-generator", label: "Social Media Bio Generator", desc: "Generate optimized and creative bios for social media profiles." },
              ].map((link) => (
                <a
                  key={link.href}
                  href={link.href}
