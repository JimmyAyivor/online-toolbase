...
const TOOL_URL = "https://www.onlinetoolbase.com/tools/mortgage-calculator";
...
function ShareBar() {
  ...
  const shareText = encodeURIComponent(
    "Free mortgage calculator — monthly payments, total interest, and full amortisation schedule. No signup.",
  );
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-xs font-semibold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
    ...
    <>
      ...
      >
        ...
        <p className="text-lg text-gray-500 text-center max-w-2xl mx-auto mb-14 leading-relaxed">
          ...
          the calculator shows your monthly payment, total interest, and a full
          amortisation schedule instantly.
        </p>
          ...
          {[
            {
              ...
              body: "Enter the purchase price of the home in the Home Price field. Adjust your down payment using either the dollar amount field or the percentage slider — the two are linked and update each other automatically. The loan amount (home price minus down payment) is shown in real time. A 20% down payment ($80,000 on a $400,000 home) is typically required to avoid PMI in the US.",
              enrich: (
                <div className="bg-emerald-50 rounded-xl px-5 py-4 text-sm text-emerald-800 leading-relaxed">
                  <strong>Down payment impact:</strong> Try dragging the down
                  payment slider from 5% to 20% and watching how the monthly
                  payment and total interest change. A larger down payment
                  reduces the loan principal, which reduces both the monthly
                  payment and the total interest paid over the loan term — and
                  eliminates PMI if you reach 20%.
                </div>
              ),
            },
            {
              n: 2,
              title: "Set the interest rate and loan term",
              body: "Enter the annual interest rate offered by your lender — even a 0.5% difference in rate has a significant impact over 30 years. Use the term buttons to select 10, 15, 20, 25, or 30 years, or type a custom term. Shorter terms have higher monthly payments but dramatically lower total interest. Compare the 15-year vs 30-year results to understand the trade-off between monthly cash flow and total loan cost.",
              enrich: (
                <div className="bg-teal-50 rounded-xl px-5 py-4 text-sm text-teal-800 leading-relaxed">
                  <strong>Rate sensitivity:</strong> On a $320,000 loan, the
                  difference between 6.0% and 7.0% is approximately $190/month
                  and nearly $70,000 in total interest over 30 years. Check your
                  lender's current rates and try both the offered rate and 0.25%
                  lower to understand the value of negotiating or shopping
            ...
            {
              n: 3,
              title: "Add property tax, insurance, and other costs",
              body: "The Additional Monthly Costs section lets you include property tax (usually quoted as an annual amount — divide by 12 for monthly), home insurance, PMI (if your down payment is under 20%), and HOA fees. These are added to your principal and interest payment to show your true total monthly housing cost. Many first-time buyers underestimate the impact of these additional costs.",
              enrich: (
                <div className="bg-emerald-50 rounded-xl px-5 py-4 text-sm text-emerald-800 leading-relaxed">
                  <strong>Total cost of ownership:</strong> For a typical US
                  home at $400,000, the principal and interest payment at 6.5%
                  for 30 years is approximately $2,528/month — but when property
                  tax ($400–$600/month), insurance ($100–$200/month), and PMI
                  (if applicable, $100–$200/month) are included, the real
                  monthly cost is often $3,100–$3,500/month. Always calculate
                  with these included for a realistic affordability assessment.
                </div>
              ),
            },
            {
              n: 4,
              title: "Review the amortisation schedule",
              body: "Click 'Show full schedule' to see a complete month-by-month breakdown of every payment over the life of the loan. Each row shows the payment number, total payment, amount going to principal, amount going to interest, and remaining balance. The schedule is paginated in 24-month blocks. Use it to see when you'll reach 50% equity, how much you owe after a specific number of years, or to understand the long-term effect of the early interest-heavy payment structure.",
              enrich: (
                <div className="bg-teal-50 rounded-xl px-5 py-4 text-sm text-teal-800 leading-relaxed">
                  <strong>Disclaimer:</strong> This calculator is for
                  informational and planning purposes only. It provides
                  estimates based on the inputs you enter and uses the standard
                  fixed-rate amortisation formula. It does not account for rate
                  changes (ARM loans), prepayment penalties, origination fees,
                  closing costs, or tax considerations. Consult a licensed
                  mortgage broker or financial advisor before making lending
                  decisions.
                </div>
              ),
            },
          ...
          {[
            {
              ...
              desc: "Understand what monthly payment you can afford before approaching lenders — calculate for multiple home price points to set a realistic budget.",
            },
            {
              emoji: "📊",
              title: "Comparing loan offers",
              desc: "Enter the same home price and down payment with different rates and terms to compare total costs across multiple lender quotes side by side.",
            },
            {
              emoji: "🔄",
              title: "Refinancing decisions",
              desc: "Calculate your new payment at a lower rate and compare to your current payment — see how quickly the monthly savings offset refinancing costs.",
            },
            {
              emoji: "💡",
              title: "Down payment planning",
              desc: "Use the slider to see how different down payment amounts affect your monthly payment — set a savings target to hit a specific monthly payment goal.",
            },
            {
              emoji: "📅",
              title: "Payoff planning",
              desc: "Use the amortisation schedule to see when your balance drops below key milestones — 80% LTV for PMI removal, 50% equity, full payoff.",
            },
            {
              emoji: "🌍",
              title: "International buyers",
              desc: "Switch currency to GBP, EUR, CAD, AUD, or JPY to calculate mortgage costs for property purchases in different countries.",
            },
        ...
        <div className="bg-gradient-to-br from-emerald-700 to-teal-800 rounded-2xl p-8 text-white text-center mb-14">
          <p className="text-xs font-semibold text-emerald-200 uppercase tracking-widest mb-4">
            Financial disclaimer
          </p>
          <h3 className="text-xl font-bold mb-3">
            A 30-year mortgage pays roughly half the home price in interest
            alone — understanding this before committing is essential
          </h3>
          <p className="text-emerald-100 leading-relaxed max-w-xl mx-auto text-sm">
            On a $400,000 home with 20% down ($320,000 loan) at 6.5% for 30
            years, you'll pay approximately $688,000 total — the $320,000 loan
            plus approximately $368,000 in interest. The interest nearly equals
            the original loan. This isn't unusual — it's the cost of long-term
            borrowing. Understanding this number before signing helps buyers
            make informed decisions about term length, down payment size, and
            whether to make additional principal payments. This calculator
            provides estimates based on the standard fixed-rate amortisation
            formula and should not be used as the sole basis for a lending
            decision. Always consult a qualified mortgage broker or financial
            ...
            {[
              {
                ...
                desc: "Calculate return on investment, annualised ROI, net profit, and return multiple for any investment.",
              },
              {
              ...
              },
              {
                ...
                desc: "Add or remove VAT from any amount — supports custom rates for any country.",
              },
            ].map((link) => (
              <a
                key={link.href}
