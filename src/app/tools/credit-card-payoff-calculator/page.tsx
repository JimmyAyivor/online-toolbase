...
export const metadata: Metadata = {
  title:
    "Credit Card Payoff Calculator — Free Online Credit Card Payoff Calculator",
  description:
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <PageEditorial />
              <ToolEngagement toolSlug="credit-card-payoff-calculator" toolName="Credit Card Payoff Calculator" />
      </SidebarAdLayout>
    </>
  );
}
