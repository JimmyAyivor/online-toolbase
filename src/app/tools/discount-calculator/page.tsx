...
export const metadata: Metadata = {
  ...
  keywords:
    "discount calculator, free discount calculator, online discount calculator, discount calculator free, discount calculator online, calculator tool, free online discount calculator, best discount calculator",
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-discount-calculator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-discount-calculator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Discount Calculator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>discount calculator</strong> is designed
              for speed and simplicity. Calculate discounted prices and savings
              for any sale or promotion. No software installation or account is
