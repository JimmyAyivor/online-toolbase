...
export const metadata: Metadata = {
  title: "Social Media Bio Generator — Free Online Social Media Bio Generator | Free Online Tools",
  description: "Generate optimized and creative bios for social media profiles. Free, instant, no signup required.",
  keywords: "social media bio generator, free social media bio generator, online social media bio generator, social media bio generator free, social media bio generator online, social media tool, free online social media bio generator, best social media bio generator",
  ...
  openGraph: {
    ...
    siteName:    SITE_NAME,
    locale:      "en_US",
    title:       "Social Media Bio Generator — Free Online Social Media Bio Generator",
    description: "Generate optimized and creative bios for social media profiles. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/social-media-bio-generator.png`, width: 1200, height: 630, alt: "Free Online Social Media Bio Generator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Social Media Tools", item: `${SITE_URL}/?category=social media` },
    { "@type": "ListItem", position: 3, name: "Social Media Bio Generator",           item: `${SITE_URL}/tools/social-media-bio-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li><a href="/?category=social media" className="hover:text-indigo-600 transition-colors">Social Media Tools</a></li>
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Social Media Bio Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Social Media Bio Generator — Free Online Social Media Bio Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate optimized and creative bios for social media profiles. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-social-media-bio-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-social-media-bio-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Social Media Bio Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>social media bio generator</strong> is designed for speed and
              simplicity. Generate optimized and creative bios for social media profiles. No software installation or account is required —
