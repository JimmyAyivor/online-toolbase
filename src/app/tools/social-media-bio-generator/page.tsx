...
export const metadata: Metadata = {
  title:
    "Free Social Media Bio Generator — All Platforms",
  description:
...
const howToJsonLd = {
  ...
  description: "Step-by-step guide to using the free Social Media Bio Generator on Calculators, Pdf Tools & More.",
  step: [
    {
      "@type": "HowToStep",
      position: 1,
