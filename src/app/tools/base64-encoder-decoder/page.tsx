...
export const metadata: Metadata = {
  title: "Base64 Encoder/Decoder — Free Online Base64 Encoder/Decoder | Free Online Tools",
  description: "Encode or decode Base64 strings instantly in your browser. Free, instant, no signup required.",
  keywords: "base64 encoder/decoder, free base64 encoder/decoder, online base64 encoder/decoder, base64 encoder/decoder free, base64 encoder/decoder online, developer tool, free online base64 encoder/decoder, best base64 encoder/decoder",
  ...
  openGraph: {
    ...
    description: "Encode or decode Base64 strings instantly in your browser. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/base64-encoder-decoder.png`, width: 1200, height: 630, alt: "Free Online Base64 Encoder/Decoder" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Base64 Encoder/Decoder",           item: `${SITE_URL}/tools/base64-encoder-decoder` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Base64 Encoder/Decoder</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Base64 Encoder/Decoder — Free Online Base64 Encoder/Decoder</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Encode or decode Base64 strings instantly in your browser. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-base64-encoder-decoder" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-base64-encoder-decoder" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Base64 Encoder/Decoder
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>base64 encoder/decoder</strong> is designed for speed and
              simplicity. Encode or decode Base64 strings instantly in your browser. No software installation or account is required —
