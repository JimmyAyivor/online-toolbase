...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${SITE_URL}/og/base64-encoder-decoder.png`,
        width: 1200,
        height: 630,
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-base64-encoder-decoder'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-base64-encoder-decoder'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Base64 Encoder/Decoder
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>base64 encoder/decoder</strong> is
              designed for speed and simplicity. Encode or decode Base64 strings
              instantly in your browser. No software installation or account is
