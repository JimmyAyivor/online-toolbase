...
export const metadata: Metadata = {
  ...
  keywords:
    "uuid/guid generator, free uuid/guid generator, online uuid/guid generator, uuid/guid generator free, uuid/guid generator online, developer tool, free online uuid/guid generator, best uuid/guid generator",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Generate unique identifiers (UUID/GUID) instantly for your
          applications. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-uuid-guid-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-uuid-guid-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free UUID/GUID Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>uuid/guid generator</strong> is designed
              for speed and simplicity. Generate unique identifiers (UUID/GUID)
              instantly for your applications. No software installation or
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4'>
              {[
                ...
                },
                {
                  ...
                  desc: "Encode or decode Base64 strings instantly in your browser.",
                },
              ].map((link) => (
                <a
                  key={link.href}
