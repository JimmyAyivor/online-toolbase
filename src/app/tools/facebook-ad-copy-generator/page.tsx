...
export const metadata: Metadata = {
  title: "Facebook Ad Copy Generator — Free Online Facebook Ad Copy Generator | Free Online Tools",
  description: "Create high-converting Facebook ad copy for marketing campaigns. Free, instant, no signup required.",
  keywords: "facebook ad copy generator, free facebook ad copy generator, online facebook ad copy generator, facebook ad copy generator free, facebook ad copy generator online, marketing tool, free online facebook ad copy generator, best facebook ad copy generator",
  ...
  openGraph: {
    ...
    siteName:    SITE_NAME,
    locale:      "en_US",
    title:       "Facebook Ad Copy Generator — Free Online Facebook Ad Copy Generator",
    description: "Create high-converting Facebook ad copy for marketing campaigns. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/facebook-ad-copy-generator.png`, width: 1200, height: 630, alt: "Free Online Facebook Ad Copy Generator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Marketing Tools", item: `${SITE_URL}/?category=marketing` },
    { "@type": "ListItem", position: 3, name: "Facebook Ad Copy Generator",           item: `${SITE_URL}/tools/facebook-ad-copy-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li><a href="/?category=marketing" className="hover:text-indigo-600 transition-colors">Marketing Tools</a></li>
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Facebook Ad Copy Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        <p className="text-xs font-semibold text-indigo-600 uppercase tracking-widest mb-1">
          Free Marketing Tool · No Signup · Works Instantly
        </p>
        <h1 className="sr-only">Facebook Ad Copy Generator — Free Online Facebook Ad Copy Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Create high-converting Facebook ad copy for marketing campaigns. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-facebook-ad-copy-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-facebook-ad-copy-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Facebook Ad Copy Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>facebook ad copy generator</strong> is designed for speed and
              simplicity. Create high-converting Facebook ad copy for marketing campaigns. No software installation or account is required —
