...
export const metadata: Metadata = {
  ...
  keywords:
    "facebook ad copy generator, free facebook ad copy generator, online facebook ad copy generator, facebook ad copy generator free, facebook ad copy generator online, marketing tool, free online facebook ad copy generator, best facebook ad copy generator",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Create high-converting Facebook ad copy for marketing campaigns. Free,
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-facebook-ad-copy-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-facebook-ad-copy-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Facebook Ad Copy Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>facebook ad copy generator</strong> is
              designed for speed and simplicity. Create high-converting Facebook
              ad copy for marketing campaigns. No software installation or
