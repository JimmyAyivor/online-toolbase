...
export const metadata: Metadata = {
  ...
  keywords:
    "random name generator, free random name generator, online random name generator, random name generator free, random name generator online, fun tool, free online random name generator, best random name generator",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Generate random names for characters, businesses, babies, or
          usernames. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-random-name-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-random-name-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Random Name Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>random name generator</strong> is designed
              for speed and simplicity. Generate random names for characters,
              businesses, babies, or usernames. No software installation or
