"use client";
// src/app/tools/freelance-rate-calculator/PageEditorial.tsx
...
const TOOL_URL = "https://www.onlinetoolbase.com/tools/freelance-rate-calculator";
const TOOL_NAME = "Freelance Rate Calculator";
...
function ShareBar() {
  ...
  const st = encodeURIComponent(
    "Free freelance rate calculator — find the hourly rate you need to charge to hit your income goal",
  );
    ...
    <>
      ...
      >
        ...
        <p className="text-lg text-gray-500 text-center max-w-2xl mx-auto mb-14 leading-relaxed">
          Enter your income target, expenses, tax rate, and working hours to
          calculate the minimum hourly rate you must charge to achieve your
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                Enter your freelance rate details
              </h3>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-14">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Calculate the minimum viable rate before quitting a salaried job,
              factoring in benefits you'll now pay yourself — health insurance,
              pension, equipment.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Recalculate each year using updated income goals, expense
              increases, and tax rate to verify your current rate still covers
              your needs.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">🤝</div>
            <p className="font-bold text-gray-900 text-sm mb-2">
              Client rate negotiation
            </p>
            <p className="text-xs text-gray-500 leading-relaxed">
              Know your floor before entering a negotiation so you can
              confidently decline below-minimum projects without
              second-guessing.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Calculate rates for different markets — US, UK, European clients —
              and adjust based on purchasing power and local competition.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">📊</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Convert your hourly rate to a project estimate by multiplying by
              expected hours plus a 20% buffer for scope creep and revision
              rounds.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              When working as a subcontractor for an agency, verify that the
              offered rate covers your billable hour cost including all
              overhead.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white text-center mb-14">
          ...
          <p className="text-blue-100 leading-relaxed max-w-xl mx-auto text-sm">
            The calculated rate is a minimum estimate based on the inputs you
            provide. Actual taxes, expenses, and billable hours will vary. This
            tool does not constitute financial or tax advice — consult a
            qualified accountant familiar with self-employment for personalised
            guidance.
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Convert hourly rate to annual salary equivalent.
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Calculate the value of any salary increase.
              </div>
            </a>
            <a
