"use client";
// src/app/tools/mortgage-affordability-calculator/PageEditorial.tsx
...
const TOOL_URL ="https://www.utilvia.com/tools/mortgage-affordability-calculator";
const TOOL_NAME = "Mortgage Affordability Calculator";
...
function ShareBar() {
  ...
  const st = encodeURIComponent(
    "Free mortgage affordability calculator — estimate how much home you can afford based on income and debts",
  );
...
const FAQS = [
  {
    q: "How do lenders determine affordability?",
    a: "Lenders primarily use two debt-to-income (DTI) ratios. The front-end ratio limits housing costs (mortgage principal, interest, taxes, insurance) to 28% of gross monthly income. The back-end ratio limits all monthly debts (housing + car loans + student loans + credit card minimums) to 36% of gross monthly income. The calculator applies both and uses the lower of the two results.",
  },
  {
    q: "What counts as 'monthly debts'?",
  ...
  },
  {
    ...
    a: "A 20% down payment eliminates the requirement for private mortgage insurance (PMI), which typically costs 0.5–1.5% of the loan annually. However, many first-time buyers use 3–10% down with FHA or conventional loans. A larger down payment means a smaller loan, lower monthly payments, and potentially a better interest rate. The minimum is 3% for conventional loans, 3.5% for FHA loans with a credit score of 580+.",
  },
  {
    q: "What other costs should I budget for?",
    a: "Beyond the mortgage payment, budget for: property taxes (0.5–2.5% of value annually, highly location-dependent), homeowner's insurance ($800–$2,000/year typically), HOA fees if applicable, maintenance (budget 1% of home value annually), and closing costs (2–5% of loan amount, paid upfront). This calculator includes estimated property tax and insurance in the monthly payment figure.",
  },
  {
    q: "How does the interest rate affect affordability?",
    a: "Interest rate has a large impact on affordability. At 5% on a $400k, 30-year loan the monthly payment is ~$2,147. At 7% it rises to ~$2,661 — a difference of $514/month or $6,168/year. A 2 percentage point increase in rates reduces maximum affordability by roughly 20% if monthly payment is fixed. This is why mortgage affordability fell sharply when rates rose in 2022–2023.",
  },
];
    ...
    <>
      ...
      >
        ...
        <p className="text-lg text-gray-500 text-center max-w-2xl mx-auto mb-14 leading-relaxed">
          Enter your income, existing debts, down payment, and interest rate to
          calculate the maximum home price and monthly payment that meets
          standard lender affordability guidelines.
        </p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                Enter your mortgage affordability details
              </h3>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-14">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="font-bold text-gray-900 text-sm mb-2">
              First home budget setting
            </p>
            <p className="text-xs text-gray-500 leading-relaxed">
              Understand your realistic price ceiling before starting your
              property search — saves time and prevents falling in love with
              unaffordable homes.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Increase the mortgage rate input by 1–2% to see how much your
              buying power shrinks — essential for planning in a rising rate
              environment.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Know your maximum before making an offer, giving you a firm upper
              limit and confidence to walk away if bidding escalates past it.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">👨‍👩‍👧</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Calculate affordability for a single income vs joint income to see
              the impact of one partner's income on buying power.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">🌍</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Compare affordability in different cities by adjusting property
              tax rate and purchase price while keeping income constant.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="text-2xl mb-3">🔄</div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Use the calculator with your current balance as 'loan amount' and
              current rate vs a refinance rate to see the monthly saving.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white text-center mb-14">
          ...
          <h3 className="text-xl font-bold mb-3">
            For estimation only — not a mortgage pre-approval
          </h3>
          <p className="text-blue-100 leading-relaxed max-w-xl mx-auto text-sm">
            Results are estimates based on the 28/36 DTI guidelines. Actual loan
            approval depends on your credit score, employment history, assets,
            and individual lender criteria. This tool does not constitute
            financial advice. Consult a mortgage lender or financial advisor for
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Project how your down payment savings grow before purchase.
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Plan your monthly budget including a new mortgage payment.
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                Calculate how long to save for a down payment target.
              </div>
            </a>
          </div>
        </div>
