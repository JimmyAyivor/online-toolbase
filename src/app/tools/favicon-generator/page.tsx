...
export const metadata: Metadata = {
  title: "Favicon Generator — Free Online Favicon Generator | Free Online Tools",
  description: "Create favicons for your website from any image, instantly. Free, instant, no signup required.",
  keywords: "favicon generator, free favicon generator, online favicon generator, favicon generator free, favicon generator online, image tool, free online favicon generator, best favicon generator",
  ...
  openGraph: {
    ...
    description: "Create favicons for your website from any image, instantly. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/favicon-generator.png`, width: 1200, height: 630, alt: "Free Online Favicon Generator" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Favicon Generator",           item: `${SITE_URL}/tools/favicon-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Favicon Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Favicon Generator — Free Online Favicon Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Create favicons for your website from any image, instantly. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-favicon-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-favicon-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Favicon Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>favicon generator</strong> is designed for speed and
              simplicity. Create favicons for your website from any image, instantly. No software installation or account is required —
