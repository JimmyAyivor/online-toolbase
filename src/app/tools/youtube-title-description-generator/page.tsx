...
export const metadata: Metadata = {
  ...
  keywords:
    "youtube title & description generator, free youtube title & description generator, online youtube title & description generator, youtube title & description generator free, youtube title & description generator online, social media tool, free online youtube title & description generator, best youtube title & description generator",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <h1 className='sr-only'>
          YouTube Title & Description Generator — Free Online YouTube Title &
          Description Generator
        </h1>
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Generate optimized YouTube titles and descriptions for better
          visibility. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <main
          id='main-content'
          aria-label='YouTube Title & Description Generator tool'
        >
        ...
        <section
          aria-labelledby='about-youtube-title-description-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-youtube-title-description-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free YouTube Title & Description Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online{" "}
              <strong>youtube title & description generator</strong> is designed
              for speed and simplicity. Generate optimized YouTube titles and
              descriptions for better visibility. No software installation or
