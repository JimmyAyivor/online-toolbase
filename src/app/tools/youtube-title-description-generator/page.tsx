...
export const metadata: Metadata = {
  title:
    "YouTube Title & Description Generator — Free Online YouTube SEO Generator",
  description:
    "Generate SEO-optimized YouTube titles and descriptions. Enter your topic and content type, get multiple title options and a full description with chapters, hashtags, and keyword sections. Free, no signup.",
  keywords:
  ...
  openGraph: {
    ...
    title:
      "YouTube Title & Description Generator — Free Online YouTube SEO Generator",
    description:
      "Generate SEO-optimized YouTube titles and descriptions. Multiple title styles, full description with chapters and hashtags. Free, no signup.",
    images: [
      {
  ...
  twitter: {
    ...
    title:
      "YouTube Title & Description Generator — Free Online YouTube SEO Generator",
    description:
      "Generate SEO-optimized YouTube titles and descriptions. Free.",
  },
};
    ...
    <>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">
          YouTube Title &amp; Description Generator — Free Online YouTube SEO
          Generator
        </h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate SEO-optimized YouTube titles and descriptions — multiple
          title styles, full description with chapters, hashtags, and keyword
          sections.
        </p>
      </header>
      <SidebarAdLayout>
