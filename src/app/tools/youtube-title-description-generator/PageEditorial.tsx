...
const TOOL_URL = "https://onlinetoolbase.com/tools/youtube-title-description-generator";
...
function ShareBar() {
  ...
  const shareText = encodeURIComponent("Free YouTube title and description generator — SEO-optimized titles and full descriptions with chapters and hashtags. No signup.");
  ...
  return (
    <>
      ...
      <section id='how-to-use' className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10' aria-labelledby='how-to-use-heading'>
        <h2 id='how-to-use-heading' className='text-4xl font-bold text-gray-900 mb-4 text-center'>How to Use the YouTube Title &amp; Description Generator</h2>
        <p className='text-lg text-gray-500 text-center max-w-2xl mx-auto mb-14 leading-relaxed'>Enter your video topic, content type, and target audience — get multiple title options across different styles and a full SEO-optimized description ready to paste into YouTube Studio.</p>
        ...
        <div className='space-y-6 mb-14'>
          <div className='bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5'>
            ...
            <div>
              <h3 className='text-lg font-bold text-gray-900 mb-2'>Enter your video topic</h3>
              <p className='text-gray-600 leading-relaxed mb-3'>Type your video's main topic into the topic field. Be specific — "how to stop procrastinating" will generate more targeted and useful titles than just "productivity". The more precise your topic, the more relevant and clickable your generated titles will be. Include any specific angle, technique, or outcome your video focuses on.</p>
              <div className='bg-red-50 rounded-xl px-5 py-4 text-sm text-red-800 leading-relaxed'><strong>Specificity tip:</strong> Instead of "fitness", try "building muscle over 40 with limited equipment". Instead of "coding", try "learning Python in 30 days with no prior experience". Specific topics generate hooks and descriptions that speak directly to your target viewer — and specific titles consistently outperform broad ones for click-through rate.</div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5'>
            ...
            <div>
              <h3 className='text-lg font-bold text-gray-900 mb-2'>Select your content type and target audience</h3>
              <p className='text-gray-600 leading-relaxed mb-3'>Choose the content type that best matches your video format — tutorial, review, vlog, listicle, case study, or documentary. Then enter your target audience. Both inputs adjust the generated titles and description to match the tone and structure your audience expects from that format. A tutorial title for beginners looks different from a case study aimed at professionals.</p>
              <div className='bg-orange-50 rounded-xl px-5 py-4 text-sm text-orange-800 leading-relaxed'><strong>Audience specificity:</strong> "beginner JavaScript developers" generates more targeted copy than "programmers". "busy parents of toddlers" generates more relevant hooks than "parents". The more precisely you define your audience, the more your titles and description will resonate with the exact people your video is made for.</div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5'>
            ...
            <div>
              <h3 className='text-lg font-bold text-gray-900 mb-2'>Choose a title style and copy your title</h3>
              <p className='text-gray-600 leading-relaxed mb-3'>The generator produces multiple titles across different proven frameworks — question, how-to, list, secret/insider, challenge, and story. Review all options before selecting one. The best title isn't always the first — read each option aloud and ask whether it would make you stop scrolling. Click Copy next to any title to copy it to your clipboard.</p>
              <div className='overflow-x-auto rounded-xl border border-gray-100 text-sm'>
                <table className='w-full text-left'>
                  <thead className='bg-gray-50'><tr><th className='px-4 py-2 text-xs font-bold text-gray-500 uppercase'>Style</th><th className='px-4 py-2 text-xs font-bold text-gray-500 uppercase'>Best for</th></tr></thead>
                  <tbody className='divide-y divide-gray-50'>
                    {[
                      ["Question",      "Curiosity-driven topics — the viewer needs the answer"],
                      ["How-to",        "Tutorial and instructional content — captures search intent"],
                      ["List / Number", "Structured advice or roundups — sets clear expectations"],
                      ["Secret / Insider", "Niche or expert content — 'what they don't tell you'"],
                      ["Challenge",     "Experiment or transformation content — 30-day, 7-day formats"],
                      ["Story",         "Personal journey or case study — for human-interest narratives"],
                    ].map(([style, best]) => (
                      <tr key={style} className='hover:bg-red-50'>
                        <td className='px-4 py-2 font-bold text-red-700 text-xs whitespace-nowrap'>{style}</td>
                        <td className='px-4 py-2 text-xs text-gray-600'>{best}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className='bg-white rounded-2xl shadow-sm border border-gray-100 p-7 flex gap-5'>
            ...
            <div>
              <h3 className='text-lg font-bold text-gray-900 mb-2'>Copy your description and customise it</h3>
              <p className='text-gray-600 leading-relaxed mb-3'>Click "Copy Description" to copy the full generated description to your clipboard. Paste it into YouTube Studio and customise it: update the chapter timestamps to match your actual video structure, add your real social media links and channel URL in the links section, replace placeholder hashtags with the specific tags most relevant to your video's niche, and add any sponsor messages or affiliate disclosures required by your channel.</p>
              <div className='bg-red-50 rounded-xl px-5 py-4 text-sm text-red-800 leading-relaxed'><strong>First 150 characters:</strong> The opening lines of your description appear in YouTube search results before the "Show more" truncation. Make sure the generated opening hook accurately describes your video and includes your primary keyword — these first lines are the most heavily weighted by YouTube's search algorithm and directly affect whether someone clicks on your video from search.</div>
            </div>
          </div>
        </div>
        ...
        <h3 className='text-2xl font-bold text-gray-900 mb-6'>Common uses for YouTube title and description generation</h3>
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-14'>
          {[
            { emoji: "🎬", title: "New channel launch", desc: "Generate optimized titles and descriptions for your first videos — start with solid SEO foundations from day one." },
            { emoji: "📈", title: "Improving existing videos", desc: "Regenerate titles and descriptions for older videos with low impressions — refresh metadata to boost search visibility." },
            { emoji: "⚡", title: "Overcoming upload bottlenecks", desc: "Remove the friction of writing metadata — generate a strong starting point in seconds and spend time refining rather than starting from blank." },
            { emoji: "🎓", title: "Educational content", desc: "Generate tutorial-format titles that capture high-intent search queries from people actively looking to learn your topic." },
            { emoji: "💼", title: "Brand and business channels", desc: "Create professional, consistent metadata for product demos, company updates, and thought leadership content." },
            { emoji: "🔄", title: "Batch content planning", desc: "Generate titles for a series of planned videos in one session — compare options and build a consistent content calendar." },
        ...
        <div className='bg-gradient-to-br from-red-600 to-orange-700 rounded-2xl p-8 text-white text-center mb-14'>
          ...
          <h3 className='text-xl font-bold mb-3'>Your title determines whether anyone watches — the description determines whether they find it</h3>
          <p className='text-red-100 leading-relaxed max-w-xl mx-auto text-sm'>YouTube's algorithm uses two signals to decide which videos to show people: click-through rate (CTR) — which is almost entirely driven by your title and thumbnail — and watch time. A great title drives clicks; watch time determines long-term distribution. Your description, meanwhile, is the primary text YouTube's search algorithm indexes to understand what your video is about. A weak description means fewer search impressions even if your video content is excellent. Treat both as equal priorities: the title earns the click, and the description earns the discovery.</p>
        </div>
        ...
        <div>
          ...
          <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4'>
            {[
              ...
              { href: "/tools/viral-hook-generator", label: "Viral Hook Generator", desc: "Generate scroll-stopping opening hooks across curiosity, controversy, story, value, and challenge frameworks." },
            ].map((link) => (
              <a key={link.href} href={link.href} className='block bg-white rounded-xl shadow-sm border-2 border-transparent hover:border-red-200 hover:-translate-y-1 transition-all duration-200 p-5' aria-label={`${link.label} — ${link.desc}`}>
