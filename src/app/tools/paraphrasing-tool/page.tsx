...
export const metadata: Metadata = {
  ...
  keywords:
    "paraphrasing tool, free paraphrasing tool, online paraphrasing tool, paraphrasing tool free, paraphrasing tool online, writing tool, free online paraphrasing tool, best paraphrasing tool",
    ...
    <>
      ...
      <header className='max-w-6xl mx-auto px-4 pt-2 pb-0'>
        ...
        <p className='hidden md:block text-sm text-gray-500 max-w-2xl mb-2'>
          Rewrite any text in different words while preserving the original
          meaning. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-paraphrasing-tool'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-paraphrasing-tool'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Paraphrasing Tool
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>paraphrasing tool</strong> is designed for
              speed and simplicity. Rewrite any text in different words while
              preserving the original meaning. No software installation or
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4'>
              {[
                ...
                },
                {
                  ...
                  desc: "Detect duplicate content and plagiarism in your text.",
                },
                {
                  href: "/tools/text-case-converter",
                  label: "Text Case Converter",
                  desc: "Convert text to uppercase, lowercase, title case, camelCase, and snake_case.",
                },
              ].map((link) => (
                <a
                  key={link.href}
