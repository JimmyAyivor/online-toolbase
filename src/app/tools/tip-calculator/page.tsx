...
export const metadata: Metadata = {
  ...
  description: "Calculate tips and split bills quickly for any restaurant or service. Free, instant, no signup required.",
  keywords: "tip calculator, free tip calculator, online tip calculator, tip calculator free, tip calculator online, calculator tool, free online tip calculator, best tip calculator",
  ...
  openGraph: {
    ...
    description: "Calculate tips and split bills quickly for any restaurant or service. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/tip-calculator.png`, width: 1200, height: 630, alt: "Free Online Tip Calculator" }],
  },
  twitter: {
    ...
    title:       "Tip Calculator — Free Online Tip Calculator",
    description: "Calculate tips and split bills quickly for any restaurant or service.",
    images:      [`${SITE_URL}/og/tip-calculator.png`],
  },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Tip Calculator",           item: `${SITE_URL}/tools/tip-calculator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Tip Calculator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Calculate tips and split bills quickly for any restaurant or service. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-tip-calculator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-tip-calculator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Tip Calculator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>tip calculator</strong> is designed for speed and
              simplicity. Calculate tips and split bills quickly for any restaurant or service. No software installation or account is required —
