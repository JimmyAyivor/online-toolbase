...
export const metadata: Metadata = {
  title: "QR Code Generator — Free Online QR Code Generator | Free Online Tools",
  description: "Generate QR codes for URLs, text, WiFi, email, and phone numbers. Free, instant, no signup required.",
  keywords: "qr code generator, free qr code generator, online qr code generator, qr code generator free, qr code generator online, developer tool, free online qr code generator, best qr code generator",
  ...
  openGraph: {
    ...
    description: "Generate QR codes for URLs, text, WiFi, email, and phone numbers. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/qr-code-generator.png`, width: 1200, height: 630, alt: "Free Online QR Code Generator" }],
  },
  twitter: {
    ...
    title:       "QR Code Generator — Free Online QR Code Generator",
    description: "Generate QR codes for URLs, text, WiFi, email, and phone numbers.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "QR Code Generator",           item: `${SITE_URL}/tools/qr-code-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">QR Code Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">QR Code Generator — Free Online QR Code Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Generate QR codes for URLs, text, WiFi, email, and phone numbers. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-qr-code-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-qr-code-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free QR Code Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>qr code generator</strong> is designed for speed and
              simplicity. Generate QR codes for URLs, text, WiFi, email, and phone numbers. No software installation or account is required —
