...
export const metadata: Metadata = {
  ...
  description: "Roll virtual dice online for board games, RPGs, and tabletop games. Free, instant, no signup required.",
  keywords: "dice roller, free dice roller, online dice roller, dice roller free, dice roller online, fun tool, free online dice roller, best dice roller",
  ...
  openGraph: {
    ...
    description: "Roll virtual dice online for board games, RPGs, and tabletop games. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/dice-roller.png`, width: 1200, height: 630, alt: "Free Online Dice Roller" }],
  },
  twitter: {
    ...
    title:       "Dice Roller — Free Online Dice Roller",
    description: "Roll virtual dice online for board games, RPGs, and tabletop games.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Dice Roller",           item: `${SITE_URL}/tools/dice-roller` },
  ],
};
    ...
    <>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Roll virtual dice online for board games, RPGs, and tabletop games. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-dice-roller" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-dice-roller" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Dice Roller
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>dice roller</strong> is designed for speed and
              simplicity. Roll virtual dice online for board games, RPGs, and tabletop games. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            { href: "/tools/meme-generator", label: "Meme Generator", desc: "Create custom memes with top and bottom text overlay on any image." },
