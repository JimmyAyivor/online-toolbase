...
export const metadata: Metadata = {
  ...
  description: "Build a professional resume with customizable templates, downloadable as PDF. Free, instant, no signup required.",
  keywords: "resume builder, free resume builder, online resume builder, resume builder free, resume builder online, business tool, free online resume builder, best resume builder",
  ...
  openGraph: {
    ...
    description: "Build a professional resume with customizable templates, downloadable as PDF. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/resume-builder.png`, width: 1200, height: 630, alt: "Free Online Resume Builder" }],
  },
  twitter: {
    ...
    title:       "Resume Builder — Free Online Resume Builder",
    description: "Build a professional resume with customizable templates, downloadable as PDF.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Resume Builder",           item: `${SITE_URL}/tools/resume-builder` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Resume Builder</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Build a professional resume with customizable templates, downloadable as PDF. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-resume-builder" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-resume-builder" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Resume Builder
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>resume builder</strong> is designed for speed and
              simplicity. Build a professional resume with customizable templates, downloadable as PDF. No software installation or account is required —
