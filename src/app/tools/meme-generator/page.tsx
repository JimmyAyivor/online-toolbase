...
export const metadata: Metadata = {
  ...
  description:
    "Create custom memes with top and bottom text overlay on any image. Free, instant, no signup required.",
  keywords:
    "meme generator, free meme generator, online meme generator, meme generator free, meme generator online, fun tool, free online meme generator, best meme generator",
  ...
  return (
    <>
      ...
      <SidebarAdLayout>
        ...
        <section
          aria-labelledby='about-meme-generator'
          className='max-w-6xl mx-auto px-4 py-12'
        >
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-10'>
            <h2
              id='about-meme-generator'
              className='text-2xl font-bold text-gray-900 mb-4'
            >
              How to Use This Free Meme Generator
            </h2>
            <p className='text-gray-600 leading-relaxed mb-4'>
              Our free online <strong>meme generator</strong> is designed for
              speed and simplicity. Create custom memes with top and bottom text
              overlay on any image. No software installation or account is
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4'>
              {[
                ...
                },
                {
                  ...
                  label: "Dice Roller",
                  desc: "Roll virtual dice online for board games, RPGs, and tabletop games.",
                },
                {
