...
export const metadata: Metadata = {
  title: "Meme Generator — Free Online Meme Generator | Free Online Tools",
  description: "Create custom memes with top and bottom text overlay on any image. Free, instant, no signup required.",
  keywords: "meme generator, free meme generator, online meme generator, meme generator free, meme generator online, fun tool, free online meme generator, best meme generator",
  ...
  openGraph: {
    ...
    description: "Create custom memes with top and bottom text overlay on any image. Free, instant, no signup.",
    images: [{ url: `${SITE_URL}/og/meme-generator.png`, width: 1200, height: 630, alt: "Free Online Meme Generator" }],
  },
  twitter: {
    ...
    title:       "Meme Generator — Free Online Meme Generator",
    description: "Create custom memes with top and bottom text overlay on any image.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Fun Tools", item: `${SITE_URL}/?category=fun` },
    { "@type": "ListItem", position: 3, name: "Meme Generator",           item: `${SITE_URL}/tools/meme-generator` },
  ],
};
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-4 pt-4 pb-2">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li><a href="/?category=fun" className="hover:text-indigo-600 transition-colors">Fun Tools</a></li>
          <li aria-hidden="true" className="text-gray-300">/</li>
          <li><span aria-current="page" className="text-gray-900 font-medium">Meme Generator</span></li>
        </ol>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-2 pb-0">
        ...
        <h1 className="sr-only">Meme Generator — Free Online Meme Generator</h1>
        <p className="hidden md:block text-sm text-gray-500 max-w-2xl mb-2">
          Create custom memes with top and bottom text overlay on any image. Free, instant, no account needed.
        </p>
      </header>
      ...
      <SidebarAdLayout>
        ...
        <section aria-labelledby="about-meme-generator" className="max-w-6xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h2 id="about-meme-generator" className="text-2xl font-bold text-gray-900 mb-4">
              How to Use This Free Meme Generator
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our free online <strong>meme generator</strong> is designed for speed and
              simplicity. Create custom memes with top and bottom text overlay on any image. No software installation or account is required —
          ...
          <div className="mt-8">
            ...
            { href: "/tools/dice-roller", label: "Dice Roller", desc: "Roll virtual dice online for board games, RPGs, and tabletop games." },
