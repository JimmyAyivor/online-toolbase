      ...
      >
        ...
        <Section title="1. Introduction">
          <p className="text-gray-700 mb-4">
            Welcome to {SITE_NAME} (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). We are committed to
            protecting your privacy and ensuring the security of your personal information.
            This Privacy Policy explains how we collect, use, disclose, and safeguard your
            information when you visit our website and use our free online tools.
          </p>
        ...
        <Section title="2. Information We Collect">
          <SubSection title="2.1 Information You Provide">
            <p className="text-gray-700 mb-4">
              Our tools process data <strong>locally in your browser</strong>. We do not
              collect, store, or transmit the data you enter into our tools (such as text,
              numbers, images, or files). All processing happens entirely on your device.
            </p>
          </SubSection>
          ...
          <SubSection title="2.2 Automatically Collected Information">
            ...
            <BulletList
              items={[
                <><strong>Usage Data:</strong> Pages visited, time spent, tools used, and referring URLs.</>,
                <><strong>Device Information:</strong> Browser type, operating system, IP address, and device identifiers.</>,
                <><strong>Cookies and Similar Technologies:</strong> Small data files stored on your device (see Section 4).</>,
              ]}
            />
          </SubSection>
        </Section>
          ...
          <SubSection title="Types of Cookies We Use">
            <BulletList
              items={[
                ...
                <><strong>Advertising Cookies:</strong> Used to deliver relevant ads through Google AdSense.</>,
              ]}
            />
          </SubSection>
          <p className="text-gray-700">
            You can instruct your browser to refuse all cookies or to indicate when a cookie is
            being sent. However, some parts of our website may not function correctly without
            cookies.
          </p>
        </Section>
        ...
        <Section title="5. Third-Party Services">
          <SubSection title="Google AdSense">
            <p className="text-gray-700 mb-4">
              ...
              based on prior visits to our website or other websites. You may opt out of
          ...
          <SubSection title="Google Analytics (or similar)">
            <p className="text-gray-700">
              We may use third-party analytics services to monitor and analyse website traffic.
        ...
        <Section title="6. Data Security">
          <p className="text-gray-700 mb-4">
            Since our tools process data locally in your browser, your input data never reaches
            our servers. We implement appropriate technical and organisational security measures
            to protect any information we do collect (usage analytics, cookies).
          </p>
          <p className="text-gray-700">
        ...
        <Section title="7. Your Privacy Rights">
          ...
          <BulletList
            items={[
              ...
              <><strong>Withdraw Consent:</strong> Withdraw consent where we rely on consent to process your information.</>,
            ]}
          />
          <p className="text-gray-700">
            To exercise any of these rights, please contact us at{" "}
            <a href="mailto:privacy@freeonlinetools.com" className="text-indigo-600 hover:underline">
              privacy@freeonlinetools.com
            </a>
            .
          </p>
        </Section>
        ...
        <Section title="10. International Data Transfers">
          <p className="text-gray-700">
            ...
            protection laws may differ from those in your jurisdiction. By using our website,
        ...
        <Section title="11. Changes to This Privacy Policy">
          <p className="text-gray-700">
            ...
            &ldquo;Last Updated&rdquo; date at the top. We encourage you to review this
        ...
        <InfoBox variant="blue" title="Key Takeaway">
          <p>
            <strong>Your data stays private.</strong> All our tools process data locally in your
            browser. We never collect, store, or transmit the data you enter into our tools. Your
            input data (text, numbers, images, files) never reaches our servers.
          </p>
        </InfoBox>
      </LegalLayout>
    </>
