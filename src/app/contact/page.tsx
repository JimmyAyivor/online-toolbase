...
const orgJsonLd = {
  ...
  contactPoint: [
    ...
    { "@type": "ContactPoint", email: "bugs@freeonlinetools.com",     contactType: "technical support" },
...
function ContactCard({ icon, bgColor, iconColor, title, email, note }: ContactCardProps) {
  return (
          ...
          <Section title="Get in Touch">
            <div className="space-y-6">
              <ContactCard
                ...
                email="support@freeonlinetools.com"
              ...
              <ContactCard
                ...
                title="Report a Bug"
                email="bugs@freeonlinetools.com"
              ...
              <ContactCard
                ...
                email="features@freeonlinetools.com"
              ...
              <ContactCard
                ...
                title="Privacy &amp; Legal"
                email="privacy@freeonlinetools.com"
              ...
              <ContactCard
                ...
                title="Legal &amp; Terms"
                email="legal@freeonlinetools.com"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <FaqItem
                ...
                answer="Absolutely! Send your ideas to features@freeonlinetools.com — we love hearing what tools people need."
              />
              <FaqItem
                question="How do I report a bug?"
                answer="Email bugs@freeonlinetools.com with the tool name, your browser and OS, and steps to reproduce the issue."
              />
              <FaqItem
