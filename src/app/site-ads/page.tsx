...
const CATEGORIES = [
  { name: "Writing & Text", tools: "Grammar checker, paraphrasing tool, text summarizer, word counter..." },
  { name: "Developer Tools", tools: "JSON formatter, JWT decoder, regex tester, base64 encoder..." },
  { name: "Finance", tools: "Sales tax calculator, mortgage calculator, budget planner, invoice generator..." },
  { name: "Health", tools: "BMI calculator, calorie calculator, macro calculator, sleep calculator..." },
  { name: "Social Media", tools: "Hashtag generator, engagement rate calculator, TikTok hook generator..." },
  { name: "Design & Image", tools: "Color palette generator, image compressor, background remover, favicon generator..." },
];
    ...
    <main className="max-w-3xl mx-auto px-4 py-16 sm:py-24">
      ...
      <div className="mb-16">
        ...
        <p className="text-lg text-gray-500 leading-relaxed max-w-xl">
          ...
          They are in a problem-solving mindset and receptive to tools that help.
          That is the right moment to introduce your product.
        </p>
      </div>
      ...
      <div className="mb-16">
        ...
        <p className="text-gray-500 mb-6 leading-relaxed">
          ...
          No banners. No pop-ups. No autoplay video. Just a clean, native-feeling
          card that matches the site's design and gives users the choice to engage.
        </p>
          ...
          <div className="border-t border-gray-100 pt-4 mt-2 text-sm">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900 text-[13px]">Your Brand</span>
            ...
            <div className="mt-3">
              <div className="flex justify-between gap-3 rounded-[1.25rem] p-3 bg-gray-50 items-center max-w-[420px]">
                <div className="flex flex-col px-1">
                  <span className="font-medium text-gray-900 text-[14px]">Your headline here</span>
                  <p className="text-gray-500 text-[13px] mt-0.5">Short supporting description — up to 80 chars.</p>
                </div>
      ...
      {/* Tool categories */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Target by category</h2>
        <p className="text-gray-500 mb-6 leading-relaxed">
          Your ad is matched to tool pages in categories you choose. A password manager
          ad appears on security tools. A writing tool appears on text and writing pages.
        </p>
        <div className="space-y-3">
          {CATEGORIES.map(c => (
            <div key={c.name} className="flex gap-4 py-3 border-b border-gray-100 last:border-0">
              <div className="w-40 shrink-0 font-medium text-gray-900 text-sm">{c.name}</div>
              <div className="text-sm text-gray-500 leading-relaxed">{c.tools}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          <div className="space-y-3">
            {[
              ...
              <div key={tier} className="flex justify-between items-center py-2 border-b border-gray-200 last:border-0">
      ...
      <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-2xl p-8 text-white">
        ...
        <p className="text-indigo-200 leading-relaxed mb-6 text-sm">
          Send us your brand name, target category, and headline idea and we will
          get back to you within one business day with availability and pricing.
        </p>
        <a
